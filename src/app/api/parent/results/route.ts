...
import { Parent, TestAttempt } from '@/models';

/**
 * Parent-only route to retrieve academic test results for linked children.
...
export async function GET(request: Request) {
  ...
  const results = await TestAttempt.find({ student: { $in: filterStudentIds } })
